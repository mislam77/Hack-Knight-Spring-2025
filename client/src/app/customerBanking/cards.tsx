...
function Cards() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
      {/* Auto Loan Card */}
      <div className="rounded-lg overflow-hidden shadow-md bg-gradient-to-r from-blue-900 to-blue-400 text-white">
        <div className="p-6">
          ...
          <div className="mt-6">
            <button className="border border-white text-white py-2 px-8 rounded-md w-full md:w-auto md:float-right hover:bg-white hover:bg-opacity-10 transition duration-300 mb-2">
              See Account
            </button>
          </div>
        </div>
      ...
      <div className="rounded-lg overflow-hidden shadow-md bg-gradient-to-r from-blue-900 to-blue-400 text-white">
        <div className="p-6">
          ...
          <div className="mt-6">
            <button className="border border-white text-white py-2 px-8 rounded-md w-full md:w-auto md:float-right hover:bg-white hover:bg-opacity-10 transition duration-300">
              See Account
            </button>
          </div>
        </div>
      ...
      <div className="rounded-lg overflow-hidden shadow-sm border border-gray-200 bg-gray-50">
        <div className="p-6">
          <div className="mb-4">
            <h2 className="text-2xl font-bold text-gray-800">Explore other products</h2>
        ...
        <div className="flex items-start">
          <div className="w-20 h-20 mr-4 flex-shrink-0">
            ...
            <div className="w-full h-full rounded-full relative flex items-center justify-center"
                style={{
                  background: "conic-gradient(from 90deg, #4ade80 0%, #a3e635 40%, #facc15 80%, #f87171 100%)",
                }}>
              <div className="absolute inset-1.5 bg-white rounded-full flex flex-col items-center justify-center">
                <span className="text-3xl font-bold text-gray-700">749</span>
          ...
          <div className="flex-1">
            <p className="text-sm font-medium mb-2">
              Saber es poder, no permitas que tu reporte de crédito te sorprenda.
            </p>
            
            <div className="mb-2 text-xs">
              <div className="flex items-center">
                <span className="mr-1">Actualizado: 11 feb 2025</span>
                <div className="w-4 h-4 rounded-full bg-red-100 flex items-center justify-center">
                  <span className="text-red-500">−</span>
                </div>
              </div>
              <p>Tienes un puntaje y reporte actualizado</p>
            </div>
