    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
            <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded shadow-md">
                <h2 className="text-2xl font-bold text-center text-gray-900 dark:text-gray-100">Face Authentication Signup</h2>
                {!isReady ? (
                    <div className="space-y-4">
                        <p className="text-center">Position your face for the camera and press the ready button when ready.</p>
                        <button
                            onClick={handleReady}
